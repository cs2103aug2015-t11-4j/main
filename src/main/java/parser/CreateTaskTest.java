...
public class CreateTaskTest {
	...
	public void testCreateDeadline() {
		Task task = new Task("deadline", "meeting tonight", null, "21/10/2015", null, "2200", false);
	...
	public void testCreateEvent() {
		Task task = new Task("event", "holiday with family", "29/11/2015", "11/12/2015", null, null, false);
		Task test = new Task();
	...
	public void testCreateFloating() {
		Task task = new Task("floating", "go themepark", null, null, null, null, false);
