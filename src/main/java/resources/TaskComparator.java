...
/*	public static final String TYPE_DEADLINE = "deadline";
	...
	static Task task1 = new Task(TYPE_DEADLINE, "wake up", null, "01/01/2015", null, "0900", false);
	static Task task2 = new Task(TYPE_DEADLINE, "wash face with cool water", null, "02/02/2015", null, "1100", true);
	static Task task3 = new Task(TYPE_EVENT, "go toilet", "01/01/2015", "01/02/2015", "0900", "1000", false);
	static Task task4 = new Task(TYPE_EVENT, "wash hand with soap", "03/02/2015", "03/02/2015", "0915", "1100", true);
	static Task task5 = new Task(TYPE_FLOATING, "meet with bob", null, null, null, null, false);
	static Task task6 = new Task(TYPE_FLOATING, "eat breakfast", null, null, null, null, true);
